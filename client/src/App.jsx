        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center p-4">
            ...
            <div className="flex flex-col items-center text-center space-y-6 max-w-4xl animate-fade-in-up">
                ...
                <div className="relative mb-4 group cursor-pointer">
                    <div className="w-48 h-48 rounded-full border-2 border-white/20 relative z-10 overflow-hidden bg-white shadow-2xl flex items-center justify-center p-3">
                        <img src="/assets/hero_logo.png" alt="Institution Logo" className="w-full h-full object-contain" />
                    </div>
                    {/* Floating Badge */}
